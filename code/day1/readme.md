...
## Vue指令
### Vue指令之插值表达式`{{}}` `v-cloak` `v-text`和`v-html`
...
<body>
  <div id="app">
    ...
    <!-- Vue 中提供了 v-on: 事件绑定机制 ，简写@ -->
    <!--下面例子会报错 ，会把alert当做变量去data中寻找，找不到报错-->
...
```
  ...
  [1]: http://static.zybuluo.com/wangkaihua5/52rubpk8ofy355fwfat891jo/01.MVC%E5%92%8CMVVM%E7%9A%84%E5%85%B3%E7%B3%BB%E5%9B%BE%E8%A7%A3.png